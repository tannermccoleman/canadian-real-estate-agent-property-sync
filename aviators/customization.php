...
function creasync_aviators_realia_customize($wp_customize) {
    creasync_aviators_realia_customize_general($wp_customize);
    creasync_aviators_realia_customize_topbar($wp_customize);
    creasync_aviators_realia_customize_header($wp_customize);
}

function creasync_aviators_realia_customize_general($wp_customize) {
    ...
    // Variant
    $wp_customize->add_setting('general_variant', array('default' => 'realia-blue'));
...
function creasync_aviators_realia_customize_topbar($wp_customize) {
...
function creasync_aviators_realia_customize_header($wp_customize) {
    ...
    // url
    $wp_customize->add_setting('header_call_to_action_url', array('default' => '/wp-admin/edit.php?post_type=property'));
    $wp_customize->add_control('header_call_to_action_url', array(
        'label' => __('Call to action URL', 'aviators'), 'section' => 'realia_header', 'settings' => 'header_call_to_action_url', 'priority' => 8,
    ));
    // text
    ...
    $wp_customize->add_control('header_call_to_action_text', array(
        'label' => __('Call to action text', 'aviators'), 'section' => 'realia_header', 'settings' => 'header_call_to_action_text', 'priority' => 9,
    ));
}

add_action('customize_register', 'creasync_aviators_realia_customize');
